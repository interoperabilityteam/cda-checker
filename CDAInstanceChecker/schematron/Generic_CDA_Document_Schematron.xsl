...
<svrl:text xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:templateId" priority="4000" mode="M4">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:templateId"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="document('TemplateIDLookUp.xml')/TemplateIdLookUp/Template/templateId[@fixedValue = current()/@extension]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="document('TemplateIDLookUp.xml')/TemplateIdLookUp/Template/templateId[@fixedValue = current()/@extension]">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error: templateId extension is not matching templateId as in the look up file. '<xsl:text/>
                  <xsl:value-of select="current()/@extension"/>
                  <xsl:text/>' has a wrong value.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::npfitlc:contentId]" priority="4000" mode="M5">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::npfitlc:contentId]"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="child::hl7v3:*[hl7v3:templateId]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="child::hl7v3:*[hl7v3:templateId]">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error: ContentId '<xsl:text/>
                  <xsl:value-of select="child::npfitlc:contentId/@extension"/>
                  <xsl:text/>' is missing templateId.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:ClinicalDocument[npfitlc:messageType]" priority="4000" mode="M8">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:contentId" priority="4000" mode="M9">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:content[@ID]" priority="4000" mode="M10">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:templateId[contains(@extension,'COCD_TP146232GB') and contains(@extension,'EncompassingEncounter')]"
                 priority="4000"
                 mode="M24">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:templateId[contains(@extension,'COCD_TP146232GB') and contains(@extension,'EncompassingEncounter')]"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="//hl7v3:id/@root='2.16.840.1.113883.2.1.3.2.4.18.34'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="//hl7v3:id/@root='2.16.840.1.113883.2.1.3.2.4.18.34'">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>'Error: no Case Reference (OID '2.16.840.1.113883.2.1.3.2.4.18.34') found in EncompassingEncounter id'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145200GB') and contains(@extension,'AssignedAuthor')]]/hl7v3:code/@nullFlavor"
                 priority="4000"
                 mode="M25">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145200GB') and contains(@extension,'AssignedAuthor')]]/hl7v3:code/@nullFlavor"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="//hl7v3:code/@nullFlavor='NI'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="//hl7v3:code/@nullFlavor='NI'">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>'Error: AssignedAuthor code nullFlavor must be NI'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145200GB') and contains(@extension,'AssignedAuthor')]]/hl7v3:id[@nullFlavor]"
                 priority="4000"
                 mode="M26">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145200GB') and contains(@extension,'AssignedAuthor')]]/hl7v3:id[@nullFlavor]"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                ...
                                test="@nullFlavor='NI'">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>'Error: AssignedAuthor id nullFlavor must be NI'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145200GB') and contains(@extension,'AssignedAuthor')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"
                 priority="4000"
                 mode="M27">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145200GB') and contains(@extension,'AssignedAuthor')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="attribute::assigningAuthorityName"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error:Author id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145201GB') and contains(@extension,'PatientRole')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"
                 priority="4000"
                 mode="M28">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145201GB') and contains(@extension,'PatientRole')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                ...
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error: Patient id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145205GB') and contains(@extension,'AssignedEntity')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"
                 priority="4000"
                 mode="M29">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145205GB') and contains(@extension,'AssignedEntity')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                ...
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error:AssignedEntity (PersonUniversal template) id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145212GB') and contains(@extension,'Workgroup')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"
                 priority="4000"
                 mode="M30">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145212GB') and contains(@extension,'Workgroup')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                ...
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error:WorkgroupUniversal Author id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145204GB') and contains(@extension,'RecipientWorkgroup')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.2 4']"
                 priority="4000"
                 mode="M31">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145204GB') and contains(@extension,'RecipientWorkgroup')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.2 4']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                ...
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error:RecipientWorkgroupUniversal id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.2 4'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145202GB') and contains(@extension,'IntendedRecipient')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"
                 priority="4000"
                 mode="M32">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145202GB') and contains(@extension,'IntendedRecipient')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                ...
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error:IntendedRecipient id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145214GB') and contains(@extension,'AssociatedEntity')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"
                 priority="4000"
                 mode="M33">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:*[child::hl7v3:templateId[contains(@extension,'COCD_TP145214GB') and contains(@extension,'AssociatedEntity')]]/hl7v3:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                ...
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
               <svrl:text>Error:Participant (DocumentParticipantUniversal) AssociatedEntity id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:telecom" priority="4000" mode="M34">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
                       context="hl7v3:telecom"/>
...
<xsl:if test="contains(@value,' ')">
         <svrl:successful-report xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                 ...
                                 test="contains(@value,' ')">
            <xsl:attribute name="location">XPath:N/A</xsl:attribute>
            <svrl:text>Error:telecom/@value should not contain ' ', as it has following value '<xsl:text/>
               <xsl:value-of select="@value"/>
               <xsl:text/>' </svrl:text>
         </svrl:successful-report>
      </xsl:if>
