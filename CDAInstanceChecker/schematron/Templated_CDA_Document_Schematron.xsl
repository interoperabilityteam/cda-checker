...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:ClinicalDocument[npfitlc:messageType]" priority="4000" mode="M6">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:contentId" priority="4000" mode="M7">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:content[@ID]" priority="4000" mode="M8">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:COCD_TP146224GB02.ObservationMedia[@ID]" priority="4000" mode="M9">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:reference[@value]" priority="4000" mode="M10">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:if test="count(//hl7v3:reference/@value[. = current()/@value]) &gt; 1">
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:* [not(ancestor::hl7v3:text)]" priority="4000" mode="M11">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="hl7v3:*[@*[substring(.,1,1)=' ']]/@*" priority="4000" mode="M22">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://www.ascc.net/xml/schematron"
